...
const shake = createMenuItem('Strawberry Shake', '5', "Drinks");

const fries = createMenuItem('French Fries', '3', "Lunch");

const bagel = createMenuItem('Plain Bagel', '2', "Breakfast");
...
let rachelReview = {
  name: "Rachel",
  rating: 3,
  feedback: "This is a fictitious review",
}

reviews.push(rachelReview);
